...
const outlinedVariants = [
  ...
  {
    props: props => isVariantAllowed(OUTLINED_VARIANTS, props.variant) && props.color === 'default',
    style: ({ theme }) => ({
  ...
  {
    props: props => isVariantAllowed(OUTLINED_VARIANTS, props.variant) && props.color === 'inherit',
    style: {
      borderColor: 'currentColor',
    },
  },
  ...(COLORS.map(colorKey => ({
    props: props => isVariantAllowed(OUTLINED_VARIANTS, props.variant) && props.color === colorKey,
    style: ({ theme }) => ({
      color: theme.vars!.palette[colorKey].main,
      borderColor: safeVarAlpha(theme.vars!.palette[colorKey].mainChannel, 0.48),
      '&:hover': {
        backgroundColor: safeVarAlpha(theme.vars!.palette[colorKey].mainChannel, 0.08),
      },
    }),
  })) satisfies ComponentsVariants<Theme>['MuiFab']),
] satisfies ComponentsVariants<Theme>['MuiFab'];
