 ...
 *
 * @example * // With gradient and image overlay
 * ...theme.mixins.bgGradient({
 *   images: [
 *     `linear-gradient(0deg, ${safeVarAlpha(theme.vars!.palette.primary.darkChannel, 0.8)}, ${safeVarAlpha(theme.vars!.palette.primary.darkChannel, 0.8)})`,
 ...
 * ...theme.mixins.bgBlur({
 *   color: safeVarAlpha(theme.vars!.palette.background.paperChannel, 0.8),
